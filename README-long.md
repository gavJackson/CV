...
A recent side project was to completely rewrite all the CSS from the past 6 years.  Providing a new layered skinning architecture written with performance and overriding in mind, as well as a modernising the look of all new projects via a white labelling approach.
